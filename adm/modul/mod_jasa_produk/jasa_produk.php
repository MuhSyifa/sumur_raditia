...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_jasa_produk/aksi_jasa_produk.php";
				$review = mysql_query("SELECT * FROM modul WHERE id_modul='4' ");
				$w=mysql_fetch_array($review);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Jasa dan Produk</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=jasa_produk&act=update'>
