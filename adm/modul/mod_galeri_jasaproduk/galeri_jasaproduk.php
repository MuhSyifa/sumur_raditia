...
<style>.ui-widget-header{background:none;border:none;}</style>
		...
		<?php
		$aksi="modul/mod_galeri_jasaproduk/aksi_galeri_jasaproduk.php";
		switch($_GET[act]){
			default:
		?>
		...
		<article style="min-width:535px;" class="module width_3_quarter">
			...
			<?php 	
				$no=1;
				$gallery = mysql_query("SELECT * FROM galeri_jasaproduk ORDER BY id ASC");
				...
				<tr>  
    				...
    				<td style="text-align:center"><a href="<?php echo"?module=galeri_jasaproduk&act=edit&id=$s[id]";?>"><input type="image" src="images/icn_edit.png" title="Edit"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td> 
				</tr> 
			<?php $no++; } ?>
		...
		<?php break; 
		case"edit":
			$galleryshow = mysql_query("SELECT * FROM galeri_jasaproduk WHERE id='$_GET[id]'");
		...
		<article class="module width_quarter">
			 ...
			 <form method='POST' enctype='multipart/form-data' action='modul/mod_galeri_jasaproduk/aksi_galeri_jasaproduk.php?module=galeri_jasaproduk&act=update'>
