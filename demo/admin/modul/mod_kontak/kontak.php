...
<!-- /TinyMCE -->
		...
		<?php 
			$aksi="modul/mod_kontak/aksi_kontak.php";
				$kontak = mysql_query("SELECT * FROM modul WHERE id_modul='6'");
				$w=mysql_fetch_array($kontak);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Kontak</h3></header>
		...
		<div class="tab_container">
			...
			<?php 	
				...
				<tr>  
    				...
    				<td style="text-align:center"><a href="<?php echo"?module=kontak&act=edit&id=$k[id_kontak]";?>"><input type="image" src="images/icn_edit.png" title="Replay"></a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo"$aksi?module=kontak&act=hapus&id=$k[id_kontak]";?>"><input type="image" src="images/icn_trash.png" title="Trash"></a></td> 
				</tr> 
			<?php } ?>
