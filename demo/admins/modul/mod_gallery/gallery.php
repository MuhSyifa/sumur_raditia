		...
		<article style="min-width:535px;" class="module width_3_quarter">
			...
			<?php 	
				...
				<tr>  
    				...
    				<td style="text-align:center"><a href="<?php echo"?module=gallery&act=edit&id=$s[id_gallery]";?>"><input type="image" src="images/icn_edit.png" title="Edit"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo"$aksi?module=gallery&act=hapus&id=$s[id_gallery]";?>" onclick="return confirm('Apakah anda yakin menghapus gallery ini?');"><input type="image" src="images/icn_trash.png" title="Trash"></a></td> 
				</tr> 
			<?php $no++; } ?>
