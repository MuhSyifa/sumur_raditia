...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_fasilitas/aksi_fasilitas.php";
				$review = mysql_query("SELECT * FROM modul WHERE id_modul='4' ");
				$w=mysql_fetch_array($review);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Facilities</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=fasilitas&act=update'>
