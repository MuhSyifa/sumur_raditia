...
<!-- /TinyMCE -->
		...
		<?php 	$aksi="modul/mod_room/aksi_room.php";
				$review = mysql_query("SELECT * FROM modul WHERE id_modul='5' ");
				$w=mysql_fetch_array($review);
				?>
		
		<article class="module width_full">
			<header><h3>Edit Room Rates</h3></header>
			<form method='POST' enctype='multipart/form-data' action='<?php echo "$aksi"; ?>?module=room&act=update'>
