...
<style>.ui-widget-header{background:none;border:none;}</style>
		...
		<article style="min-width:535px;" class="module width_3_quarter">
			<header><h3 class="tabs_involved">Banner</h3>
			...
			<?php 	
				...
				<tr>  
    				...
    				<td width="30%"><img height="120px" src="../joimg/banner/<?php echo"$s[gambar]" ?>"></td> 
    				<td style="text-align:center"><a href="<?php echo"?module=banner&act=edit&id=$s[id_banner]";?>">
    				<input type="image" src="images/icn_edit.png" title="Edit"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    				<!-- <a href="<?php echo"$aksi?module=banner&act=hapus&id=$s[id_banner]";?>" onclick="return confirm('Apakah anda yakin menghapus banner ini?');">
		...
		<article style="min-width:260px;" class="module width_quarter">
			 <header><h3>Maksimal 2 Banner</h3></header>
			 <form method='POST' enctype='multipart/form-data' action='modul/mod_banner/aksi_banner.php?module=banner&act=insertnew'>
				<div class="module_content">
						...
						<fieldset style="float:left; width:30%; margin-right: 3%;"> 
							...
							<p style="text-align:center; color: #ff0000;">(* Ukuran Gambar harus 300x150px. *)</p>
						</fieldset>
		...
		<?php break; 
		case"edit":
			$bannershow = mysql_query("SELECT * FROM banner WHERE id_banner='$_GET[id]'");
